...
function TController_GeraSQL.SetColunas(
  Colunas: TMemo): iController_GeraSQL;
begin
  Result   := self;
  Fcolunas := Colunas;
end;

function TController_GeraSQL.SetCondicao(
  Condicao: TMemo): iController_GeraSQL;
begin
  Result := Self;
  FCondicao := Condicao;
end;

function TController_GeraSQL.SetTabela(
  Tabela: TMemo): iController_GeraSQL;
begin
  Result := Self;
  FTabela := Tabela;
end;
